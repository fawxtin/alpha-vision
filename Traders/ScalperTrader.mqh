...
void AlphaVisionTraderScalper::calculateBuyEntry(EntryExitSpot &ee, int timeframe, int trend, double signalPrice, string signalOrigin="") {
   AlphaVision *av = m_signals.getAlphaVisionOn(timeframe);
   BBTrend *bb = av.m_bb;
...
void AlphaVisionTraderScalper::calculateSellEntry(EntryExitSpot &ee, int timeframe,int trend,double signalPrice, string signalOrigin="") {
   AlphaVision *av = m_signals.getAlphaVisionOn(timeframe);
   BBTrend *bb = av.m_bb;
   BBTrend *bb4 = av.m_bb4;
