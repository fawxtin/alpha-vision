...
*** Multiple EntryPoints schema, through list/hash
    Create entry points schemas to be attached to AlphaVisionTrader.
    The entry points can be disabled or deattached, on some trending/volatility rule.
